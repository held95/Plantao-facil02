        ...
        <Container style={container}>
          ...
          {plantao.descricao && (
            <Section style={descriptionBox}>
              <Text style={detailLabel}>INFORMACOES IMPORTANTES:</Text>
          ...
          {plantao.requisitos && plantao.requisitos.length > 0 && (
            <Section style={requirementsBox}>
              <Text style={requirementLabel}>REQUISITOS:</Text>
              <ul style={list}>
          ...
          <Section style={reminderBox}>
            <Text style={reminderText}>
              Você receberá notificações 24 horas e 1 hora antes do plantão.
            </Text>
          </Section>
